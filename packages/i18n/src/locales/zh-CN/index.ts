...
sklm: {
    ...
    defaultPermissionsDesc: "默认情况下，这是一个助手可以读取和修改当前项目中的文件；更高风险操作会先征求你的同意。",
    permissionMode: "权限模式",
    ...
    autoReview: "自动审批",
    autoReviewDesc: "这是一个助手可以读写当前项目文件，并自动处理额外权限请求。自动审批也可能判断失误。",
    learnMore: "了解更多",
    autoReviewLearnMoreAfter: " 关于高风险的信息。",
    fullAccess: "完全访问权限",
    fullAccessDesc: "开启完全访问后，这是一个助手可不经确认修改电脑上的任意文件并执行网络命令，会显著增加数据丢失或意外改动的风险。",
    ...
    closeBehaviorTrayDesc: "在系统托盘中继续运行这是一个助手。",
