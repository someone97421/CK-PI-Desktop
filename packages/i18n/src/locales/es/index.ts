...
sklm: {
    ...
    "piSyncDesc":
      "Copia manualmente las definiciones de proveedores, las claves de API y el modelo predeterminado entre PI-Desktop y el CLI pi del sistema (~/.pi/agent). Los inicios de sesión de suscripción nunca se copian.",
