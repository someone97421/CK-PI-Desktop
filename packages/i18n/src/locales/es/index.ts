...
sklm: {
    ...
    "compactionModel": "Modelo de compactación de contexto",
    "changeCompactionModel": "Cambiar",
    "compactionModelFollow": "Seguir el modelo predeterminado",
    "compactionModelFollowHint":
      "Se usa el modelo principal si el modelo elegido no cubre su ventana de contexto o sus modalidades de entrada.",
    "compactionModelUnavailable":
      "No disponible: {{provider}} · {{model}}. Elige otro modelo o sigue el predeterminado.",
    "compactionModelUpdated": "Modelo de compactación de contexto actualizado",
...
"importConfirm": "Las extensiones importadas se ejecutan en el proceso del agente con el mismo acceso que sus propias herramientas. Las habilidades declaradas pueden añadir instrucciones al agente y las dependencias declaradas se instalan con npm (scripts de instalación desactivados). ¿Continuar?",
    ...
    "permissionHelp": {
      ...
      "provider.register": "Agregue los proveedores que define este complemento a la lista de proveedores de Configuración. El complemento aporta el punto final y los modelos; su clave API permanece en this-is-a-agent.",
