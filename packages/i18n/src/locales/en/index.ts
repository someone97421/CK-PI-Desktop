...
sklm: {
    ...
    defaultPermissionsDesc: "By default, this-is-a-agent can read and edit files in your project. It will ask before doing anything riskier.",
    permissionMode: "Permission mode",
    ...
    autoReviewDesc: "this-is-a-agent can read and edit files in your project, and will automatically decide on extra access requests. Auto-review can make mistakes.",
    learnMore: "Learn more",
    autoReviewLearnMoreAfter: " about high-risk information.",
    fullAccess: "Full access permissions",
    fullAccessDesc: "With full access, this-is-a-agent can edit files anywhere on your computer and run network commands without asking. This raises the risk of data loss or unexpected changes.",
    ...
    closeBehaviorTrayDesc: "Keep this-is-a-agent running in the system tray.",
    closeBehaviorQuit: "Quit app",
    closeBehaviorQuitDesc: "Exit this-is-a-agent completely.",
