export const en = {
  ...
  chat: {
    ...
    subagentReportProgress: "Report {{current}} / {{interval}} steps · {{total}} total",
    subagentSegment: "Segment {{segment}} · {{steps}} completed steps",
    subagentLatestReport: "Report #{{seq}} · Steps {{from}}–{{to}}",
