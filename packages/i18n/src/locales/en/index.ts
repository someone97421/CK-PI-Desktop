...
sklm: {
    ...
    piSyncDesc:
      "Manually copy provider definitions, API keys, and the default model between PI-Desktop and the system pi CLI (~/.pi/agent). Subscription logins are never copied.",
