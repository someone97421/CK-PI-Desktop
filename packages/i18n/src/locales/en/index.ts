export const en = {
  app: {
    name: "this-is-a-agent",
    shellName: "this-is-a-agent",
    tagline: "Local AI coding partner",
    starting: "Starting this-is-a-agent…",
  ...
  tray: {
    ...
    pinned: "Pinned",
    viewMore: "View more…",
    open: "Open this-is-a-agent",
    quit: "Quit this-is-a-agent",
    askTitle: "Keep this-is-a-agent running in the background?",
    askBody:
      "When you close the window, this-is-a-agent can keep running in the system tray so nothing is lost. You can change this any time in Settings.",
    closeToTray: "Close to tray",
    confirmQuitTitle: "Quit this-is-a-agent?",
    confirmQuitBody:
  ...
  nav: {
    ...
    recents: "Recents",
    settings: "Settings",
    remoteOn: "LAN remote access · On",
    remoteOff: "LAN remote access · Off",
    remoteUnavailable: "LAN remote access · Status unavailable",
    computerUseOn: "Computer Use · On",
    computerUseOff: "Computer Use · Off",
    computerUseStarting: "Computer Use · Starting",
    computerUseUnavailable: "Computer Use · Error, open panel for details",
    help: "Help",
    ...
    projectSortManual: "Manual order",
    projectSortCreated: "Project creation date",
    projectSortActive: "Session activity",
  ...
  chat: {
    taskDelivery: {
      duration: "Worked for {{minutes}}m {{seconds}}s",
      durationUnknown: "Duration unknown",
      tokensUnknown: "Tokens not reported",
      ...
      incomplete: "Incomplete usage",
      estimated: "Duration is estimated",
      aborted: "Stopped",
      failed: "Failed",
      steering: "Additional instruction",
      review: "Review file changes",
      close: "Close",
      noChanges: "No reviewable change records",
      files: "{{count}} file(s) with recorded changes",
      edits: "{{count}} edit(s)",
      editNumber: "Edit {{number}}",
      scope: "Includes traceable Write/Edit records in the loaded messages for this task. Loading earlier messages may reveal more records.",
      missingEvidence: "Some successful operations have no available snapshot; their diff cannot be shown.",
      evidenceOnly: "Snapshots are grouped by file. A net task diff is not available. Line counts belong to each individual operation and must not be added together as net changes.",
    },
    ...
    placeholder: "Ask this-is-a-agent to help with anything",
    ...
    fileMenuCopyPath: "Copy full path",
    fileMenuCopyContent: "Copy file contents",
    fileMenuReveal: "Show in folder",
    fileMenuResolving: "Locating file…",
    filePathCopied: "Full path copied to clipboard",
    fileContentCopied: "File contents copied to clipboard",
    fileCopyFailed: "Couldn't copy to the clipboard",
    fileContentNotText: "Only a complete text file can be copied — this one is binary, a folder, or too large",
    fileActionFailed: "The file action failed",
    retry: "Regenerate",
    ...
    sessionCompactionModel: "Compaction model",
    sessionCompactionScope: "Context compaction model for this conversation only",
    sessionCompactionFollow: "Follow global setting",
    sessionCompactionUnavailable: "{{provider}} · {{model}} (unavailable)",
    ...
    subagentStrip: "Subagents in this conversation",
    subagentStripOrder: "Newest dispatch on the left; scroll to browse",
    subagentStripRetry: "Could not load earlier tasks. Click to retry",
    ...
    subagentExecution: "Execution {{execution}}",
    subagentReworking: "Reworking · Execution {{execution}}",
    subagentRecallReady: "Completed · Available for parent recall",
    subagentRecallCheck: "Past execution · Recall depends on retained context",
    subagentRecallMemoryOnly: "Context exists only in the current session runtime's memory. Configuration changes, runtime release or application restart cannot restore it.",
    subagentHistorical: "Historical record · no active execution",
    subagentStoppingNow: "Stopping; waiting for in-flight operations…",
    subagentGuidingNow: "Guidance queued; waiting for the current tool…",
    subagentReportProgress: "Next report: {{current}} / {{interval}} calls · {{total}} total tool calls",
    subagentReportSummary: "Reports sent: {{reports}} · {{total}} total tool calls",
    subagentCallSummary: "Total tool calls: {{total}}",
    subagentReportProgressHint: "The numerator counts finished tool calls in this batch. A report is generated every {{interval}} calls, then the count resets. This is not task completion progress.",
    subagentReportSummaryHint: "Report count means reports generated by the runtime, not confirmed as read by the main agent. Total tool calls include failed calls.",
    subagentToolCalls: "{{count}} completed tool call",
    subagentToolCalls_other: "{{count}} completed tool calls",
    subagentProcessRecords: "{{count}} activity record",
    subagentProcessRecords_other: "{{count}} activity records",
    subagentProcessRecordsHint: "Includes tool calls, thinking, explanations and reports shown in the transcript. This is not the tool call count.",
    subagentSegment: "Segment {{segment}} · {{steps}} completed tool calls",
    subagentLatestReport: "Report #{{seq}} · Tool calls {{from}}–{{to}}",
    subagentReportedStatement: "Subagent statement:",
    subagentReportTruncated: "Summary truncated. Full tool output is available in the execution records.",
    ...
    subagentSourceMemory: "Memory",
    subagentSourceDisk: "Disk",
    subagentSnapshotVersion: "Snapshot v{{version}}",
    subagentRevokeRecall: "Revoke future recall",
    subagentRevokeRecallTooltip: "Mark as stopped to revoke cross-restart recall eligibility",
    subagentRevokingNow: "Revoking recall eligibility…",
    subagentPersistenceState: {
      "memory-only": "Recallable · Memory",
      "saving": "Saving snapshot",
      "durable-ready": "Recallable · Saved",
      "pending-validation": "Pending validation",
      "blocked": "Configuration incompatible",
      "revoked": "Stopped (Revoked)",
...
sklm: {
    ...
    skillRoots: "Extra paths",
    skillRootsDesc:
      "Reference skill directories another agent owns. Documents are read live and never modified here.",
    skillRootsHint: "Absolute path to an existing directory.",
    skillRootsPlaceholder: "e.g. ~/.claude/skills",
    skillRootsAdd: "Add extra path",
    skillRootsConfirm: "Add",
    skillRootsEmpty: "No extra paths yet",
    skillRootsCount: "{{count}} skills",
    skillRootsRowDesc: "Read-only reference; this app never writes these documents.",
    skillRootsRemove: "Remove path {{path}}",
    skillRootsBadge: "External",
    skillUnlinkImport: "Unlink imported skill",
    skillUnlinkImportConfirm: "Click again to unlink",
    skillUnlinkImportDone: "Import link removed; source files kept",
    skillRootAdded: "Added extra path {{path}}",
    skillRootRemoved: "Removed extra path {{path}}",
    mcp: "MCP servers",
    ...
    subagentPersistenceDesc: "Allows completed subagents to be recalled and reworked across app restarts. Snapshots are encrypted locally using OS secure storage.",
    subagentPersistenceEnable: "Persist completed subagent contexts",
    subagentPersistenceStatus: "Storage status",
    subagentPersistenceAvailable: "Secure storage available",
    subagentPersistenceUnavailable: "Secure storage unavailable ({{reason}})",
    ...
    subagentPersistenceClear: "Clear snapshots",
    subagentPersistenceClearConfirm: "Clear all snapshots?",
    subagentPersistenceClearDesc: "Deletes all stored subagent snapshot payloads from disk to free up disk space. Historical results, transcripts, and audit records are retained.",
    subagentPersistenceCleared: "Cleared {{cleared}} snapshots.",
    subagentPersistenceClearFailed: "Failed to clear snapshots",
    subagentPersistenceCancel: "Cancel",
    browser: "Browser",
    ...
    piSyncTitle: "pi configuration sync",
    piSyncDesc:
      "Manually copy provider definitions, API keys, and the default model between this-is-a-agent and the system pi CLI (~/.pi/agent). Subscription logins are never copied.",
    piSyncUnavailable: "pi CLI configuration not found at {{dir}}.",
    piSyncAvailable: "pi CLI configuration: {{dir}}",
    piSyncLastSynced: "Last synced {{time}}",
    piSyncNeverSynced: "Never synced",
    piSyncDrift: "The pi files changed since the last sync.",
    piSyncImportAction: "Import from pi",
    piSyncExportAction: "Export to pi",
    piSyncPreviewTitle: "Export preview",
    piSyncPreviewEmpty: "Nothing to export.",
    piSyncConfirm: "Apply export",
    piSyncCancel: "Cancel",
    piSyncDone: "pi export finished: {{applied}} applied, {{skipped}} skipped",
    piSyncActionCreate: "create",
    piSyncActionUpdate: "update",
    piSyncActionRemoved: "removed",
    piSyncActionUnchanged: "unchanged",
    piSyncSkipOauth: "subscription login not copied",
    piSyncSkipUnresolved: "command/env value not resolved",
    piSyncSkipDuplicate: "duplicate provider key",
    ...
    preventScreenSleepDesc: "Keep the display awake while the app is running.",
    ...
    showMenuBarDesc: "Keep this-is-a-agent in the macOS menu bar when the main window is closed.",
    ...
    appearanceAutoSave: "Changes apply and save automatically. Light and dark settings are independent and only affect built-in themes. System mode follows your OS.",
    appearanceContrast: "Contrast",
    appearanceContrastDesc: "How strongly panels, cards, and borders separate. 50 is the built-in look; lower flattens, higher sharpens.",
    appearanceContrastMode: "{{mode}} contrast",
    appearanceAccent: "Accent color",
    appearanceBackground: "Background color",
    appearanceForeground: "Foreground color",
    appearanceColorPicker: "Choose {{label}}",
    appearanceHexError: "Use #RRGGBB or #RGB.",
    appearanceUiFont: "UI font",
    appearanceUiDesc: "Menus, controls, and navigation.",
    appearanceContentFont: "Content font",
    appearanceContentDesc: "Messages, thinking, and Markdown file previews.",
    appearanceCodeFont: "Code font",
    appearanceCodeDesc: "Inline code, code blocks, and source previews. Missing glyphs fall back to system monospace and CJK fonts.",
    appearanceDefaultMono: "Default monospace",
    appearanceLegacyFont: "Default ({{font}})",
    appearanceWeightLabel: "{{scope}} weight",
    appearanceDefaultWeight: "Default weight",
    appearanceStaticWeights: "Actual static faces (upright, normal width preferred).",
    appearanceVariableRange: "Variable font wght range: {{ranges}}. Save numeric input with Enter or on blur.",
    appearanceVariableValue: "Variable wght {{weight}}",
    appearanceVariableFixed: "{{name}} (VF fixed weight {{weight}})",
    appearanceNoWeightAxis: "This variable font has no wght axis; only its actual fixed weight is offered.",
    appearanceCssWeight: "Generic CSS {{weight}}",
    appearanceWeightFallback: "Default stack or metadata unavailable: generic CSS weights 1–1000, not actual font faces. Save numeric input with Enter or on blur.",
    appearanceWeightLoading: "Reading actual font faces…",
    appearanceUnsupportedValue: "{{weight}} (saved, unsupported)",
    appearanceUnsupportedWeight: "Saved weight {{weight}} is preserved but unsupported by this font; the browser may match or synthesize it. Choose an actual face, an in-range value, or the default. Changing fonts never rewrites the weight automatically.",
    appearanceWeightNumber: "{{scope}} value",
    appearanceWeightInvalid: "Enter a supported value (CSS weights must be within 1–1000), or leave empty for the default.",
    appearanceReset: "Restore defaults",
    appearanceResetMode: "Restore {{mode}} defaults",
    appearanceSaveError: "Could not save settings. The latest unsaved change was reverted; try again.",
    customAppIcon: "App icon",
    customAppIconDesc: "PNG image for the app window and system tray.",
    customMediaTitle: "Custom images",
    customHomeMedia: "Home image",
    customHomeMediaDesc: "PNG, GIF, WebP, MP4 or WebM. Videos play muted and loop.",
    customMediaChoose: "Choose file",
    customMediaReset: "Restore default",
    customMediaError: "Could not set the image. Check the file format and try again.",
    customMediaSize: "Home image size",
    customMediaDefault: "Using default image",
    fontSystem: "System",
    fontCustom: "Saved",
  ...
  scheduled: {
    description: "Run recurring agent tasks while this-is-a-agent is open.",
    edit: "Edit task",
    ...
    localTimeHint: "Uses this computer’s local timezone. Keep this-is-a-agent running; missed runs are skipped.",
  ...
  panel: {
    ...
    subagentLoading: "Loading subagent history…",
    subagentLoadError: "Could not load subagent history.",
    subagentRetry: "Retry",
    subagentConversation: "Conversation",
    subagentDetail: "Process",
...
importConfirm: "Imported extensions run inside the agent process with the same access as the agent's own tools. Declared skills can add instructions to the agent, and declared dependencies are installed with npm (install scripts disabled). Continue?",
  ...
  extensions: {
    ...
    subagents: {
      ...
      maxTokens: "Output limit per response (tokens)",
      maxTokensHint: "Maximum tokens generated per model request, not the task's total output or context capacity. Enter 1–{{max}}, or leave empty to follow the model. The model's actual limits still apply; reasoning-token accounting depends on the provider.",
      ...
      reportInterval: "Report interval (tool calls)",
      reportIntervalHint: "Report every N completed tool calls while continuing to work. This is not an execution limit.",
      reportIntervalDefault: "Set by the main agent when delegating",
      errorReportInterval: "Enter a positive safe integer, or leave empty for the main agent to specify.",
  ...
  status: {
    ...
    dbSchemaTooNew:
      "This this-is-a-agent is older than your local data (data schema {{found}}, this build supports {{supported}}). Install the newer this-is-a-agent that last opened this data, or a later version.",
    archMismatch:
