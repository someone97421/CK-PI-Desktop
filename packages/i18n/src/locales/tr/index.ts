...
sklm: {
    ...
    piSyncDesc:
      "Sağlayıcı tanımlarını, API anahtarlarını ve varsayılan modeli PI-Desktop ile sistem pi CLI (~/.pi/agent) arasında elle eşitleyin. Abonelik oturumları asla kopyalanmaz.",
