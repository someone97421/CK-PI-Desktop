...
sklm: {
    ...
    "piSyncDesc":
      "Copiez manuellement les définitions de fournisseurs, les clés API et le modèle par défaut entre PI-Desktop et le CLI pi système (~/.pi/agent). Les connexions d'abonnement ne sont jamais copiées.",
