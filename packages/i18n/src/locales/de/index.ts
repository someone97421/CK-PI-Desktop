...
sklm: {
    ...
    "piSyncDesc":
      "Anbieterdefinitionen, API-Schlüssel und das Standardmodell manuell zwischen PI-Desktop und der System-pi-CLI (~/.pi/agent) abgleichen. Abonnement-Anmeldungen werden nie kopiert.",
