...
export const IPC = {
  invoke: {
    ...
    piSyncStatus: "pi-desktop/piSync/status",
    piSyncPreviewExport: "pi-desktop/piSync/previewExport",
    piSyncExport: "pi-desktop/piSync/export",
    ...
    skillRootsList: "pi-desktop/skill/roots/list",
    skillRootsAdd: "pi-desktop/skill/roots/add",
    skillRootsRemove: "pi-desktop/skill/roots/remove",
  ...
  event: {
    ...
    closePrompt: "pi-desktop/window/event/closePrompt",
